...
public class ArbysTest extends AbstractBrandTest {
        ...
        @Test(description = "Verify the hero heading reads 'Franchise with Arby's'", groups = { "smoke", "arbys",
                        "hero" })
        ...
        @Test(description = "Verify liquid assets requirement of $500,000 is displayed", groups = { "regression",
                        "arbys",
                        "qualification" })
