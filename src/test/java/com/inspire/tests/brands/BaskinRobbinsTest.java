 ...
 * TC-B-12) from {@link AbstractBrandTest} and adds Baskin-Robbins-specific
 * tests (TC-BR-01 to TC-BR-09).
 *
 * <p>
 * All expected values are resolved from
 * {@code src/test/resources/brands/baskin-robbins.properties}
 * via {@link com.inspire.config.ConfigReader} — never hardcoded.
 *
 * <p>
...
public class BaskinRobbinsTest extends AbstractBrandTest {
    ...
    /** Typed convenience accessor to avoid repeated casts in Baskin-Robbins tests. */
    ...
    public void TC_BR_02_verifyHeroHeadingIsBaskinRobbins() {
        ...
        Assert.assertTrue(
                ...
                "Hero heading should contain 'Franchise with Baskin-Robbins' but was: '" + heading + "'");
    ...
    public void TC_BR_04_verifyAwardsDisplayed() {
        ...
        Assert.assertTrue(
                ...
                "Entrepreneur Best of the Best award text should be visible");

        logStep("Checking Top Food Franchise award");
        Assert.assertTrue(
    ...
    @Test(description = "Verify the shop count factoid ('7,800 retail shops') is displayed", groups = { "regression",
            "baskin-robbins" })
