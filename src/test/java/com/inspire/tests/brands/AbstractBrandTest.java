 ...
 *
 * <p>Contains all <em>common</em> test cases that apply to every brand page on
 ...
 *
 * <p>Open/Closed Principle: adding a new brand test class does not require
 * modifying this class. Simply extend it and add brand-specific tests.
 *
 * <p>Template Method Pattern: {@link #getBrandPage()} is the abstract hook that
...
public abstract class AbstractBrandTest extends BaseTest {
    ...
    @org.testng.annotations.Test(
        description = "Verify the brand page loads successfully at its expected URL",
    ...
    /**
     * TC-B-02: Verify the hero heading follows the "Franchise with [Brand]" pattern.
     */
    @org.testng.annotations.Test(
        description = "Verify the hero heading contains 'Franchise with [Brand Name]'",
        groups = {"smoke", "brand-common", "hero"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify the hero 'GET STARTED' call-to-action button is displayed",
        groups = {"smoke", "brand-common", "hero"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify GET STARTED button navigates to the franchise enquiry form",
        groups = {"smoke", "brand-common", "navigation"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify 'Why [Brand]?' section is displayed",
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify 'Here's how we help' section is displayed",
        groups = {"regression", "brand-common"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify all three support pillars are displayed: Training, Marketing, Technology",
        groups = {"regression", "brand-common"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify the franchise qualification requirements section is displayed",
        groups = {"regression", "brand-common"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify the 'What's next?' section is displayed",
        groups = {"regression", "brand-common"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify all 5 franchise process steps (Apply, Discuss, Review, Interview, Sign) are displayed",
        groups = {"regression", "brand-common"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify the page footer is displayed",
        groups = {"regression", "brand-common", "footer"}
    )
     ...
     */
    @org.testng.annotations.Test(
        description = "Verify the 'Or franchise with any of Inspire's brands' cross-brand section is displayed",
        groups = {"regression", "brand-common", "footer"}
    )
