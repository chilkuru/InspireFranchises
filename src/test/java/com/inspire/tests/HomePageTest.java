 ...
 *
 * <p>
 * TC-H-01 through TC-H-10 cover critical user journeys on the home page.
 ...
 * <li>Carries a {@code description} attribute that appears in the Extent
 * report.
...
public class HomePageTest extends BaseTest {
    ...
    @Test(description = "Verify the home page loads successfully and the URL is correct", groups = { "smoke", "home" })
    ...
    @Test(description = "Verify the hero section heading 'Anything is Possible' is displayed", groups = { "smoke",
            "home", "hero" })
    ...
    @Test(description = "Verify the hero heading text is exactly 'Anything is Possible'", groups = { "regression",
            "home", "hero" })
    ...
    @Test(description = "Verify the hero 'GET STARTED' CTA button is displayed", groups = { "smoke", "home", "hero" })
    ...
    @Test(description = "Verify clicking 'GET STARTED' navigates to the franchise enquiry form", groups = { "smoke",
            "home", "navigation" })
    ...
    @Test(description = "Verify the 'Grow with Inspire's Iconic Brands' section is visible", groups = { "regression",
            "home" })
    ...
    @Test(description = "Verify 'Our Brands' navigation menu contains 'Arby's'", groups = { "regression", "home",
            "navigation" })
    ...
    @Test(description = "Verify Arby's brand link on the home page body navigates to the Arby's page", groups = {
            "regression", "home", "navigation" })
    ...
    @Test(description = "Verify the page footer is displayed with company name", groups = { "regression", "home",
            "footer" })
    ...
    @Test(description = "Verify the LinkedIn link is present in the footer", groups = { "regression", "home",
            "footer" })
    ...
    @Test(description = "Verify the 'How do I become a franchisee?' section is present", groups = { "regression",
            "home" })
